...
class TestBM25Retriever:
    ...
    def test_bm25_keyword_matching(self):
        ...
        assert any(
            "anticipatory" in r["document"].page_content.lower() for r in results
        )
...
class TestCrossEncoderReranker:
    ...
    def test_reranker_with_metadata(self):
        ...
        docs_with_scores = [
            {"document": SAMPLE_DOCS[0], "bm25_score": 10.5, "semantic_score": 0.8},
            {"document": SAMPLE_DOCS[1], "bm25_score": 8.2, "semantic_score": 0.9},
        ]
