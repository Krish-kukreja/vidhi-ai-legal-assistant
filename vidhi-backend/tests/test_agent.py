...
class TestAgentTools:
    ...
    def test_search_legal_database_with_filter(self, agent_tools):
        ...
        results = agent_tools.search_legal_database(
            "Section 438 CrPC", doc_type="legislation", top_k=5
        )
    ...
    def test_calculate_limitation_period_valid(self, agent_tools):
        ...
        result = agent_tools.calculate_limitation_period("civil", "2023-01-01")
    ...
    def test_calculate_limitation_period_invalid_date(self, agent_tools):
        ...
        result = agent_tools.calculate_limitation_period("civil", "invalid-date")
    ...
    def test_calculate_limitation_period_cognizable(self, agent_tools):
        ...
        result = agent_tools.calculate_limitation_period("cognizable", "2023-01-01")
...
class TestVidhiAgent:
    ...
    def test_create_vidhi_agent(
        self, mock_llm, mock_retriever, agent_tools, mock_logger
    ):
        """Test agent creation."""
...
class TestAgentNodes:
    ...
    def test_confidence_node(self, vidhi_agent):
        ...
        state: AgentState = {
            "query": "Section 438 CrPC",
            "expanded_query": ["Section 438 CrPC"],
            "retrieved_docs": [{"content": "test", "metadata": {}, "confidence": 0.9}],
            "tool_calls": [],
            "reasoning_steps": [],
...
class TestAgentHelpers:
    ...
    def test_extract_citations(self, vidhi_agent):
        ...
        docs = [{"metadata": {"source": "CrPC"}, "content": "test"}]
