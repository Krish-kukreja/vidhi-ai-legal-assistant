...
def mock_llm_service():
    ...
    async def mock_stream(question, session_id="default", language="English", use_agent=None):
...
def mock_llm_service_with_error():
    ...
    async def mock_stream_error(question, session_id="default", language="English", use_agent=None):
...
def test_stream_chat_empty_response(client):
    ...
    async def mock_stream_empty(question, session_id="default", language="English", use_agent=None):
        yield {
            "type": "done",
            "total_tokens": 0,
            "duration_ms": 100
