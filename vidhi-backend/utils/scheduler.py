...
class DataRefreshScheduler:
    ...
    def refresh_all_data(self):
        ...
        try:
            ...
            if success:
                logger.info(f"Data refresh completed successfully in {refresh_record['duration_seconds']:.1f}s")
            else:
    ...
    def full_refresh(self):
        ...
        try:
            ...
            if success:
                logger.info(f"Full data refresh completed successfully in {refresh_record['duration_seconds']:.1f}s")
            else:
    ...
    def trigger_manual_refresh(self, refresh_type: str = "incremental") -> Dict[str, Any]:
