...
DYNAMODB_TABLE_EMBEDDING_CACHE = os.getenv(
...
BEDROCK_MODEL_ID_ADVANCED = os.getenv(
    "BEDROCK_MODEL_ID_ADVANCED", "anthropic.claude-3-sonnet-20240229-v1:0"
)
BEDROCK_EMBEDDINGS_MODEL = os.getenv(
...
SCHEMES_JSON_PATH = (
    "data_pipeline/raw/myschemes_full.json"  # Updated to new scraper output
)
...
ENABLE_DOCUMENT_ANALYSIS = (
    os.getenv("ENABLE_DOCUMENT_ANALYSIS", "True").lower() == "true"
)
...
def get_embeddings():
    ...
    try:
        ...
        return BedrockEmbeddings(
            model_id=BEDROCK_EMBEDDINGS_MODEL, region_name=AWS_REGION
        )
